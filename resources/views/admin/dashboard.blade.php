        ...
        <div class="col-lg-8">
            <div class="admin-card">
                <div class="admin-card-header">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="btn btn-sm btn-outline-primary rounded-lg">View All
                        Orders</a>
                </div>
                                ...
                                @forelse($recentOrders as $order)
                                    <tr>
                                        <td class="ps-4">
                                            ...
                                            <small
                                                class="text-muted text-xs">{{ $order->user->name ?? $order->first_name }}</small>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span
                                                class="badge {{ $badgeClass }} px-3 py-2 rounded-lg small">{{ ucfirst($order->status) }}</span>
                                        </td>
                                        <td class="text-end pe-4">
                                            <a href="{{ route('admin.orders.show', $order) }}"
                                                class="btn btn-sm btn-link text-primary fw-bold text-xs p-0">Details</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-5 text-muted small">No recent transaction data
                                            available.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="admin-card-body">
                    <div class="stock-alerts">
                        ...
                        <div class="stock-alert-item healthy">
                            ...
                            <div class="stock-alert-description">92% of orders were delivered within 48 hours this week.
                            </div>
                        </div>

                        <div class="mt-4 p-3 bg-light rounded-lg">
                            <h6 class="fw-bold mb-2 small">Admin Support</h6>
                            <p class="small text-muted mb-0">Need help managing your store? Check out the <a href="#"
                                    class="text-primary fw-bold">Admin Guide</a> or contact technical support.</p>
                        </div>
                    </div>
                </div>
            </div>
