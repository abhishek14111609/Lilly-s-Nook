...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=Dancing+Script:wght@700&display=swap" rel="stylesheet">
        ...
        @else
            <style>
                ...
                * {
                ...
                @keyframes glow {
                    from { text-shadow: 0 0 20px rgba(244, 143, 177, 0.5), 0 0 40px rgba(244, 143, 177, 0.3); }
                    to { text-shadow: 0 0 30px rgba(244, 143, 177, 0.8), 0 0 50px rgba(244, 143, 177, 0.5); }
                }
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p class="hero-description fade-in">
                    Discover a curated collection of premium fashion and lifestyle products designed to elevate your everyday experience. Immerse yourself in a world of sophistication and style.
                </p>
        ...
        <section class="features">
            <div class="features-grid">
                <div class="feature-card fade-in">
                    ...
                    <p class="feature-description">Experience the finest materials and craftsmanship in every piece we offer.</p>
                </div>
            ...
            <div class="categories-grid">
                <div class="category-card fade-in">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Elegant dresses, trendy tops, and sophisticated accessories for the modern woman.</p>
                ...
                <div class="category-card fade-in-delay-1">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Premium suits, casual wear, and accessories that define masculine elegance.</p>
                        <a href="#" class="category-link">Explore Collection →</a>
                    </div>
                </div>
                <div class="category-card fade-in-delay-2">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Luxury cosmetics, skincare products, and beauty essentials for your daily routine.</p>
                        <a href="#" class="category-link">Explore Collection →</a>
                    </div>
                </div>
                <div class="category-card fade-in">
                ...
                <div class="category-card fade-in-delay-1">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Stylish shoes and boots for every occasion, combining comfort with fashion.</p>
                        <a href="#" class="category-link">Explore Collection →</a>
                    </div>
                </div>
                <div class="category-card fade-in-delay-2">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Elegant home decor, furniture, and lifestyle products for your living space.</p>
                        <a href="#" class="category-link">Explore Collection →</a>
                    </div>
                </div>
            </div>
        ...
        <section class="products-showcase">
            ...
            <div class="products-grid">
                <div class="product-card fade-in">
                    ...
                    <p class="product-description">Elegant silk dress perfect for special occasions. Available in multiple colors.</p>
                    <a href="#" class="btn-primary" style="text-decoration: none; display: inline-block;">View Details</a>
                </div>
                <div class="product-card fade-in-delay-1">
                    <span class="product-badge">Best Seller</span>
                    <h3 class="product-title">Leather Handbag</h3>
                    <div class="product-price">₹8,499</div>
                    <p class="product-description">Premium leather handbag with spacious compartments and elegant design.</p>
                    <a href="#" class="btn-primary" style="text-decoration: none; display: inline-block;">View Details</a>
                </div>
