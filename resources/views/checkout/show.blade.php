                                ...
                                @foreach ($addresses as $address)
                                    <div class="col-md-6">
                                        <div class="address-selector p-3 border rounded-3 position-relative cursor-pointer {{ $address->is_default ? 'border-primary bg-primary-subtle' : '' }}"
                                            ...
                                            data-city="{{ $address->city }}" data-zip="{{ $address->zip_code }}"
                                            data-phone="{{ $address->phone }}">
                                            <div class="d-flex justify-content-between">
                                                <span
                                                    class="badge bg-white text-primary border border-primary-subtle rounded-pill small px-2 py-1 mb-2">{{ strtoupper($address->type) }}</span>
                                                @if ($address->is_default)
                                                    <span class="text-primary small fw-bold">Default</span>
                                                @endif
                                            </div>
                                            <p class="fw-bold small mb-1">{{ $address->first_name }}
                                                {{ $address->last_name }}</p>
                                            <p class="text-muted text-xs mb-0">{{ $address->city }},
                                                {{ $address->zip_code }}</p>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="first_name" class="form-control"
                                    value="{{ old('first_name') }}" required placeholder="Jane">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control" rows="3" required
                                    placeholder="House number, Street, Near Landmarks...">{{ old('address') }}</textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" name="phone" class="form-control border-start-0"
                                        value="{{ old('phone') }}" required placeholder="9988776655">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="p-3 bg-light rounded-3 border mb-4">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">You will be redirected to complete payment securely.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm rounded-4 p-4 sticky-top" style="top: 100px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center bg-light p-3 rounded-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted text-xs mb-0">{{ $item->size }} × {{ $item->quantity }}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-between mb-0 border-top pt-3">
                        ...
                        <h5 class="fw-bold text-primary">₹{{ number_format($grand_total, 2) }}</h5>
                    </div>

                    <div class="mt-4 text-center">
                        <p class="text-muted text-xs"><svg width="14" height="14" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" class="me-1">
                                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                            </svg> 100% Secure Transaction</p>
                    </div>
                </div>
            </div>
        </div>
