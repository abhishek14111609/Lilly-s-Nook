            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="mt-4">
                        @csrf
                        <button type="submit" class="btn btn-outline-danger w-100 rounded-pill py-2 fw-bold">Sign
                            Out</button>
                    </form>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="row g-4 mb-5">
                            ...
                            <div class="col-12">
                                <label class="form-label small fw-bold text-uppercase letter-spacing-1">Email
                                    Address</label>
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                <p class="mb-0 text-muted small">Account created on
                                    {{ $user->created_at?->format('F d, Y') }}</p>
                            </div>
                            <button type="submit" class="btn btn-primary rounded-pill px-5 py-3 fw-bold shadow">Update
                                Profile</button>
                        </div>
                    </form>
                </div>
